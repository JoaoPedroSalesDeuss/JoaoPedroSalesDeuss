...
<div style="display: flex; align-items: center;">
    <img alt="Header" src="https://github.com/JoaoPedroSalesDeuss/JoaoPedroSalesDeuss/blob/main/minha%20pasta/7zop.gif?raw=true" style="width: 50px; height: auto; margin-right: 20px; animation-play-state: running;"/>
    <div>
